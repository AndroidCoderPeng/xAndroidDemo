...
import com.example.android.extensions.showAnimation
...
class AddProductActivity : KotlinBaseActivity<ActivityAddProductBinding>() {
    ...
    override fun initViewBinding(): ActivityAddProductBinding {
