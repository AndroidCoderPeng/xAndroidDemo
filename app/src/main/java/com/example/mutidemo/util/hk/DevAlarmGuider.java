...
//        }
    ...
    public CGReturn Test_SetupAlarm_jni(int iUserID) {
        ...
        if (-1 == iAlarmHandle) {
            ret.result = 0;
            System.out.println("NET_DVR_SetupAlarmChan_V41 failed!" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.result = 1;
    ...
    public CGReturn Test_SetupAlarm_V50_jna(int iUserID) {
        ...
        if (-1 == iAlarmHandle) {
            ret.result = 0;
            System.out.println("NET_DVR_SetupAlarmChan_V50 failed!" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.result = 1;
    ...
    public CGReturn Test_CloseAlarm_jni(int iAlarmHandle) {
        if (!HCNetSDK.getInstance().NET_DVR_CloseAlarmChan_V30(iAlarmHandle)) {
            ret.result = 0;
            System.out.println("NET_DVR_CloseAlarmChan_V30 failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.result = 1;
