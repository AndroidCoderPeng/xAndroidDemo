...
public class SocketManager implements ISocketListener {
    ...
    private int covertDataValue(int[] bytes) {
    ...
    private double covertAngleValue(int[] bytes) {
