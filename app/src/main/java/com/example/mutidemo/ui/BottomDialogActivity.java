...
public class BottomDialogActivity extends BaseNormalActivity implements OnItemClickListener, OnDismissListener {
    ...
    public void initData() {
        ...
        ViewGroup extView = (ViewGroup) LayoutInflater.from(this).inflate(R.layout.layout_dialog, null);
    ...
    public void alertShow3(View view) {
        new AlertView(null, null, null, new String[]{"高亮按钮"},
    ...
    public void alertShow4(View view) {
        new AlertView("标题", null, "取消", new String[]{"高亮按钮"}, new String[]{"其他按钮1", "其他按钮2", "其他按钮3"}, this, AlertView.Style.ActionSheet, this).show();
    }
