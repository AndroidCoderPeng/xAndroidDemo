package com.example.mutidemo.ui.zxing.scanner;
...
import com.example.mutidemo.ui.zxing.camera.CameraManager;
import com.example.mutidemo.ui.zxing.config.Constant;
import com.example.mutidemo.ui.zxing.config.ZxingConfig;
import com.example.mutidemo.ui.zxing.decode.DecodeImgCallback;
import com.example.mutidemo.ui.zxing.decode.DecodeImgThread;
import com.example.mutidemo.ui.zxing.decode.ImageUtil;
import com.example.mutidemo.ui.zxing.view.ViewfinderView;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    public void switchFlashImg(int flashState) {
        if (flashState == Constant.FLASH_OPEN) {
            flashLightIv.setImageResource(R.mipmap.ic_launcher);
            flashLightTv.setText("关闭闪光灯");
        } else {
            flashLightIv.setImageResource(R.mipmap.ic_launcher_round);
