...
public class DevConfigGuider implements Serializable {
    ...
    public CGReturn test_ControlScreen_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_RemoteControl(iUserID, HCNetSDK.getInstance().NET_DVR_CONTROL_SCREEN, struCtrlControl_V41)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_CONTROL_SCREEN success!");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_CONTROL_SCREEN fail,error code = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_SignalList_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetInputSignalList_V40(iUserID, 0, struList)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GetInputSignalList_V40 success!" + struList.dwInputSignalNums);
            ...
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GetInputSignalList_V40 fail,error code = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_FileInfo_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetSTDConfig(iUserID, HCNetSDK.NET_DVR_GET_SCREEN_FILEINFO, condInt, null, screenFileInfo)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_SCREEN_FILEINFO" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
            //return false;
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            String filename = new String(screenFileInfo.byFileName);
            Log.i("Casic", "java out filename:" + filename);
            //Log.i("Casic","Filename;");
            for (int i = 0; i < 256; i++) {
                Log.i("Casic", " java fileName:" + screenFileInfo.byFileName[i]);
            }
            Log.i("Casic", "type:" + screenFileInfo.byFileType);
            Log.i("Casic", "byPictureFormat:" + screenFileInfo.byPictureFormat);
        }
        if (!HCNetSDK.getInstance().NET_DVR_SetSTDConfig(iUserID, HCNetSDK.NET_DVR_SET_SCREEN_FILEINFO, condInt, screenFileInfo, null)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SET_SCREEN_FILEINFO" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
            //return false;
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SET_SCREEN_FILEINFO success");
        }
        return ret;
    }
    ...
    public CGReturn test_SerialAbility_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDeviceAbility(iUserID, HCNetSDK.getInstance().DEVICE_SERIAL_ABILITY, lpInBuf, 1024, lpOutBuf, 100 * 1024)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GetDeviceAbility success");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GetDeviceAbility fail,error code = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_loginCfg_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_STDXMLConfig(iUserID, struInput, struOutput)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_STDXMLConfig success");
            Log.i("Casic", "dwReturnXMLSize=" + struOutput.dwReturnedXMLSize);

        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_STDXMLConfig fail,error code = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
    ...
    public CGReturn test_PlayingPlan_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_PLAYING_PLAN, 1, lpOutPtr)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_PLAYING_PLAN success");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_PLAYING_PLAN fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_CtrlPlan_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_RemoteControl(iUserID, HCNetSDK.getInstance().NET_DVR_CTRL_PLAN, struCtrlParam)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_CTRL_PLAN success");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_CTRL_PLAN fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_Plan_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_SET_PLAN, 1, struPlanCfg)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SET_PLAN success");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SET_PLAN fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_VWParam_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDeviceConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_VW_SCENE_PARAM, dwCount, arrStatus1, pstruWallInfo, lpOut1, intPtr1)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_VW_SCENE_PARAM success");
            Log.i("Casic", "intPtr.iValue=" + intPtr1.iValue);
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_VW_SCENE_PARAM fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        dwCount = 1;
        ...
        if (HCNetSDK.getInstance().NET_DVR_SetDeviceConfig(iUserID, HCNetSDK.getInstance().NET_DVR_SET_VW_SCENE_PARAM, dwCount, pstruWallInfo, arrStatus, lpOut1)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SET_VW_SCENE_PARAM success");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SET_VW_SCENE_PARAM fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDeviceConfig(iUserID, HCNetSDK.NET_DVR_GET_VW_SCENE_PARAM, 1,
            ...
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_VW_SCENE_PARAM fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
            //return ;
        } else {
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn test_CurrentScene_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDeviceConfig(iUserID, HCNetSDK.NET_DVR_GET_CURRENT_SCENE, struWallInfo1, lpOut)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_CURRENT_SCENE success!");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_CURRENT_SCENE fail,error code=" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_SceneControl_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_RemoteControl(iUserID, HCNetSDK.getInstance().NET_DVR_SCENE_CONTROL, struCtrlInfo)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SCENE_CONTROL success!");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SCENE_CONTROL fail,error code=" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_DecChanEnable_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_MatrixGetDecChanEnable(iUserID, dwDecChanNum, lpEnable)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "lpEnalbe=" + lpEnable.iValue);
            Log.i("Casic", "NET_DVR_MatrixGetDecChanEnable success!");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_MatrixGetDecChanEnable  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        lpEnable.iValue = 1;
        if (HCNetSDK.getInstance().NET_DVR_MaxtrixSetDecChanEnable(iUserID, dwDecChanNum, lpEnable.iValue)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_MaxtrixSetDecChanEnable success!");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_MaxtrixSetDecChanEnable  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_SwitchWin_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_RemoteControl(iUserID, HCNetSDK.getInstance().NET_DVR_SWITCH_WIN_TOP, lpWallNo)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SWITCH_WIN_TOP success!");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SWITCH_WIN_TOP  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        if (HCNetSDK.getInstance().NET_DVR_RemoteControl(iUserID, HCNetSDK.getInstance().NET_DVR_SWITCH_WIN_BOTTOM, lpWallNo)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SWITCH_WIN_BOTTOM success!");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SWITCH_WIN_BOTTOM  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_WallInParam_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_WALLWINPARAM_GET, iChannel, struWallParam)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_WALLWINPARAM_GET success!");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_WALLWINPARAM_GET  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_WALLWINPARAM_SET, iChannel, struWallParam)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_WALLWINPARAM_SET success!");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_WALLWINPARAM_SET  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_CloseAll_jni(int iUserID) {
        ...
        if (bRet) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_VIDEOWALLWINDOW_CLOSEALL success!");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_VIDEOWALLWINDOW_CLOSEALL  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_Position_jni(int iUserID) {
        ...
        if (bRet) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_VIDEOWALLWINDOWPOSITION success!");
            Log.i("Casic", "nRet =" + nRet.iValue);
            ...
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_VIDEOWALLWINDOWPOSITION fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (bRet) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SET_VIDEOWALLWINDOWPOSITION success!");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SET_VIDEOWALLWINDOWPOSITION  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_DisplayPosition_jni(int iUserID) {
        ...
        if (bRet) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_VIDEOWALLDISPLAYPOSITION success!");
            Log.i("Casic", "nRet=" + nRet.iValue);
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_VIDEOWALLDISPLAYPOSITION fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (bRet) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SET_VIDEOWALLDISPLAYPOSITION success!");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SET_VIDEOWALLDISPLAYPOSITION  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_WallOutput_jni(int iUserID) {
        ...
        if (bRet) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_WALLOUTPUT_GET success!");
            Log.i("Casic", "nRet=" + nRet.iValue);
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_WALLOUTPUT_GET fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (bRet) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_WALLOUTPUT_SET success!");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_WALLOUTPUT_SET  fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn test_PlanList_jni(int iUserID) {
        ...
        if (bRet) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GetPlanList success!");
            Log.i("Casic", "planList.dwPlanNums=" + planList.dwPlanNums);
            ...
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GetPlanList fail,error code =" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
...
//     */
    ...
    public CGReturn test_ScreenCtrl_jni(int iUserID) {
        ...
        if (lHandle < 0) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_StartRemoteConfig NET_DVR_START_SCREEN_CRTL failed" + MessageCodeHub.INSTANCE.getErrorCode());
            return ret;
        }
        ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        Log.i("Casic", "NET_DVR_StartRemoteConfig NET_DVR_START_SCREEN_CRTL succeed");
        try {
            Thread.sleep(100);
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SendRemoteConfig((int) lHandle, LONG_CFG_SEND_DATA_TYPE_ENUM.ENUM_DVR_SCREEN_CTRL_CMD, struCmd)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SendRemoteConfig NET_DVR_START_SCREEN_CRTL failed");
            return ret;
        }
        ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
        Log.i("Casic", "NET_DVR_SendRemoteConfig NET_DVR_START_SCREEN_CRTL succeed");
        try {
            Thread.sleep(2000);
        } catch (InterruptedException e) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_StopRemoteConfig(lHandle)) {
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_StopRemoteConfig NET_DVR_START_SCREEN_CRTL failed");
        } else {
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_StopRemoteConfig NET_DVR_START_SCREEN_CRTL succeed");
        }
        return ret;
    }
    ...
    public CGReturn test_UploadFile_jni(int iUserID) {
        ...
        if (lHandle < 0) {
            ret1.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_UploadFile_V40 UPLOAD_SCREEN_FILE is failed!Err:" + MessageCodeHub.INSTANCE.getErrorCode());
            return ret1;
        } else {
            ret1.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_UploadFile_V40 UPLOAD_SCREEN_FILE Success!");
            return ret1;
        }
    }
    ...
    public CGReturn test_Download_jni(int iUserID) {
        ...
        if (lHandle < 0) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_StartDownload is failed!Err:"
                    + MessageCodeHub.INSTANCE.getErrorCode());
            return ret;
        }
        ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (press.iValue == 100) {
                ...
                if (bRet) {
                    ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
                    Log.i("Casic", "NET_DVR_StopDownload Success!");
                } else {
                    ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
                    Log.i("Casic", "NET_DVR_StopDownload error!");
                }
    ...
    public CGReturn test_ScreenFileList_jni(int iUserID) {
        ...
        if (lHandle < 0) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_StartRemoteConfig NET_DVR_GET_SCREEN_FLIE_LIST failed");
            return ret;
        }
        ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        Log.i("Casic", "NET_DVR_StartRemoteConfig NET_DVR_GET_SCREEN_FLIE_LIST succeed");

        INT_PTR pState = new INT_PTR();
        if (!HCNetSDK.getInstance().NET_DVR_GetRemoteConfigState((int) lHandle, pState)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GetRemoteConfigState NET_DVR_GET_SCREEN_FLIE_LIST failed");
            return ret;
        }
        ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
        Log.i("Casic", "NET_DVR_GetRemoteConfigState NET_DVR_GET_SCREEN_FLIE_LIST succeed");
        ...
        while (iCond == 1) {
            ...
            if (lRet < 0) {
                ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
                Log.e("Casic", "NET_DVR_GetNextRemoteConfig NET_DVR_GET_SCREEN_FLIE_LIST failed " + MessageCodeHub.INSTANCE.getErrorCode());
                return ret;
            }
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GetNextRemoteConfig NET_DVR_GET_SCREEN_FLIE_LIST succeed" + struFileInfo.byFileName);
            if (lRet == NET_SDK_GET_NEXT_STATUS.NET_SDK_GET_NEXT_STATUS_SUCCESS || lRet == NET_SDK_GET_NEXT_STATUS.NET_SDK_GET_NETX_STATUS_NEED_WAIT) {
                ...
                Log.i("Casic", "NET_DVR_GetNextRemoteConfig NET_DVR_GET_SCREEN_FLIE_LIST finished");
                break;
            } else if (lRet == NET_SDK_GET_NEXT_STATUS.NET_SDK_GET_NEXT_STATUS_FAILED) {
                Log.e("Casic", "NET_DVR_GetNextRemoteConfig NET_DVR_GET_SCREEN_FLIE_LIST error");
                break;
            }
        }

        if (!HCNetSDK.getInstance().NET_DVR_StopRemoteConfig((int) lHandle)) {
            Log.e("Casic", "NET_DVR_StopRemoteConfig NET_DVR_GET_SCREEN_FLIE_LIST failed");
            return ret;
        }
        Log.i("Casic", "NET_DVR_StopRemoteConfig NET_DVR_GET_SCREEN_FLIE_LIST succeed");
        return ret;
    }
    ...
    public CGReturn test_ScreenConfig_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetSTDConfig(iUserID, HCNetSDK.NET_DVR_GET_SCREEN_CONFIG, null, null, screenConfig)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_SCREEN_CONFIG" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_SCREEN_CONFIG succ" + "volume: " + screenConfig.byVolume);
        }
        return ret;
    }
    ...
    public CGReturn test_ScreenConfigCap_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetSTDAbility(iUserID, HCNetSDK.NET_DVR_GET_SCREEN_CONFIG_CAP, null, 0, byAbility, 1024 * 1024, iRetLen)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_GET_SCREEN_CONFIG_CAP" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_GET_SCREEN_CONFIG_CAP success");
        }
        i = MessageCodeHub.INSTANCE.getErrorCode();
        return ret;
    }
    ...
    public CGReturn test_WallAbility_jni(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDeviceAbility(iUserID, HCNetSDK.getInstance().WALL_ABILITY, lpInBuf, 1024, lpOutBuf, 100 * 1024)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GetDeviceAbility WallAbility success");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GetDeviceAbility WallAbility fail,error code = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
...
//        struOuput.dwOutBufferSize = 0;
        if (!HCNetSDK.getInstance().NET_DVR_STDXMLConfig(iUserID, struInput, struOuput)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_STDXMLConfig(PUT) faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_ShutDown_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_ShutDownDVR(iUserID)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_ShutDownDVR faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_RebootDVR_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_RebootDVR(iUserID)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_RebootDVR faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_ClickKey_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_ClickKey(iUserID, NET_DVR_KEY_CODE.KEY_CODE_MENU)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_ClickKey faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (lFormatHandle >= 0) {
            ...
            while (ptrFormatStatic.iValue == 0) {
                if (!HCNetSDK.getInstance().NET_DVR_GetFormatProgress(lFormatHandle, ptrCurrentDisk, ptrCurrentPos, ptrFormatStatic)) {
                    ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
                    System.out.println("NET_DVR_GetFormatProgress failed with:" + MessageCodeHub.INSTANCE.getErrorCode());
                    break;
                } else {
                    ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            ...
            if (!HCNetSDK.getInstance().NET_DVR_CloseFormatHandle(lFormatHandle)) {
                ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
                System.out.println("NET_DVR_CloseFormatHandle failed with:" + MessageCodeHub.INSTANCE.getErrorCode());
            }
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_FormatDisk failed with:" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn Test_Upgrade_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetNetworkEnvironment(0)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SetNetworkEnvironment err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        }
        ...
        if (nUpgradeHandle == -1) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_Upgrade err:" + MessageCodeHub.INSTANCE.getErrorCode());
            return ret;
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            int nProgress = 0;
            ...
            if (nProgress == -1) {
                ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
                System.out.println("NET_DVR_GetUpgradeProgress err:" + MessageCodeHub.INSTANCE.getErrorCode());
            } else {
                ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            }
            if (!HCNetSDK.getInstance().NET_DVR_CloseUpgradeHandle(nUpgradeHandle)) {
                System.out.println("NET_DVR_CloseUpgradeHandle err:" + MessageCodeHub.INSTANCE.getErrorCode());
            }
        }
        return ret;
    }
    ...
    public CGReturn Test_ActivateDevice_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_ActivateDevice("10.10.35.16", 8000, activateCfg)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_ActivateDevice failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
...
//		HCNetSDK.getInstance().NET_DVR_SetSimAbilityPath(path, strSDCard);
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetXMLAbility(iUserID, HCNetSDK.DEVICE_ENCODE_ALL_ABILITY_V20, arrayInBuf, strInput.length(), arrayOutBuf, 64 * 1024, intPtr)) {
            System.out.println("get DEVICE_ENCODE_ALL_ABILITY_V20 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_PTZProtocol(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetPTZProtocol(iUserID, struPtzCfg)) {
            System.out.println("NET_DVR_GetPTZProtocol faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_PresetName(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_PRESET_NAME, iChan, struPresetNameArray)) {
            System.out.println("NET_DVR_GET_PRESET_NAME faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_ShowString(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_SHOWSTRING_V30, iChan, struShowString)) {
            System.out.println("NET_DVR_GET_SHOWSTRING_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_SET_SHOWSTRING_V30, iChan, struShowString)) {
            System.out.println("NET_DVR_SET_SHOWSTRING_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_DigitalChannelState(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_DIGITAL_CHANNEL_STATE, 0, struChanState)) {
            System.out.println("NET_DVR_GET_DIGITAL_CHANNEL_STATE faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_DDNSPara(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_DDNSCFG_V30, 0, struDDNS)) {
            System.out.println("NET_DVR_GET_DDNSCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_SET_DDNSCFG_V30, 0, struDDNS)) {
            System.out.println("NET_DVR_SET_DDNSCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_APInfoList(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_AP_INFO_LIST, 0, struAPInfoList)) {
            System.out.println("NET_DVR_GET_AP_INFO_LIST faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_WifiCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_WIFI_CFG, 0, struWifiCfg)) {
            System.out.println("NET_DVR_GET_WIFI_CFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_SET_WIFI_CFG, 0, struWifiCfg)) {
            System.out.println("NET_DVR_SET_WIFI_CFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_WifiStatus(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_WIFI_STATUS, 0, struStatus)) {
            System.out.println("NET_DVR_GET_WIFI_STATUS faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_UpnpNatState(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetUpnpNatState(iUserID, struUpnpNat)) {
            System.out.println("NET_DVR_GetUpnpNatState faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_UserCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_USERCFG_V30, 0, struUserCfg)) {
            System.out.println("NET_DVR_GET_USERCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_USERCFG_V30, 0, struUserCfg)) {
            System.out.println("NET_DVR_SET_USERCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_DeviceCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_DEVICECFG, 0, struDeviceCfg)) {
            System.out.println("NET_DVR_GET_DEVICECFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_DeviceCfg_V40(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_DEVICECFG_V40, 0, struDeviceCfg)) {
            System.out.println("NET_DVR_GET_DEVICECFG_V40 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
...
//		}
    ...
    public static void Test_ExceptionCfg_V40(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_EXCEPTIONCFG_V40, iChan, struExceptionCfg)) {
            System.out.println("NET_DVR_GET_EXCEPTIONCFG_V40 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_PicCfg(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_PICCFG_V30, iChan, struPiccfg)) {
            System.out.println("NET_DVR_GET_PICCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_PICCFG_V30, iChan, struPiccfg)) {
            System.out.println("NET_DVR_SET_PICCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_ZeroChanCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_ZEROCHANCFG, 1, struZeroChanCfg)) {
            System.out.println("NET_DVR_GET_ZEROCHANCFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_ZEROCHANCFG, 1, struZeroChanCfg)) {
            System.out.println("NET_DVR_SET_ZEROCHANCFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_WorkState(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRWorkState_V30(iUserID, struWorkState)) {
            System.out.println("NET_DVR_GetDVRWorkState_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_RecordCfg(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_RECORDCFG_V30, iChan, struRecordCfg)) {
            System.out.println("NET_DVR_GET_RECORDCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_RECORDCFG_V30, iChan, struRecordCfg)) {
            System.out.println("NET_DVR_SET_RECORDCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
...
//        }
    ...
    public static void Test_AuxAlarmCfg(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_IPC_GET_AUX_ALARMCFG, iChan, struAuxAlarm)) {
            System.out.println("NET_IPC_GET_AUX_ALARMCFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_AlarminCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_ALARMINCFG_V30, 0, struAlarmIn)) {
            System.out.println("NET_DVR_GET_ALARMINCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_ALARMINCFG_V30, 0, struAlarmIn)) {
            System.out.println("NET_DVR_SET_ALARMINCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_AlarmOutCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_ALARMOUTCFG_V30, 0, struAlarmOut)) {
            System.out.println("NET_DVR_GET_ALARMOUTCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_ALARMOUTCFG_V30, 0, struAlarmOut)) {
            System.out.println("NET_DVR_SET_ALARMOUTCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_DecoderCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_DECODERCFG_V30, 1, struDecoderCfg)) {
            System.out.println("NET_DVR_GET_DECODERCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_DECODERCFG_V30, 1, struDecoderCfg)) {
            System.out.println("NET_DVR_SET_DECODERCFG_V30 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_NTPPara(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_NTPCFG, 0, NtpPara)) {
            System.out.println("get NtpPara faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_NTPCFG, 0, NtpPara)) {
            System.out.println("Set NtpPara faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_IPAlarmOutCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_IPALARMOUTCFG, 0, struIpAlarmOut)) {
            System.out.println("NET_DVR_GET_IPALARMOUTCFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_IPParaCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_IPPARACFG_V40, 0, IpPara)) {
            System.out.println("NET_DVR_GET_IPPARACFG_V40 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_IPPARACFG_V40, 0, IpPara)) {
            System.out.println("NET_DVR_SET_IPPARACFG_V40 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_NetCfg(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_NETCFG_V30, 0, NetCfg)) {
            System.out.println("get net cfg faied!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_NETCFG_V30, 0, NetCfg)) {
            System.out.println("Set net cfg faied!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_CompressionCfg(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_COMPRESSCFG_V30, iChan, CompressionCfg)) {
            System.out.println("get CompressionCfg failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_COMPRESSCFG_V30, iChan, CompressionCfg)) {
            System.out.println("Set CompressionCfg failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_CompressCfgAud(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_COMPRESSCFG_AUD, 1, AudioCompress)) {
            System.out.println("get AudioCompress failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_AlarmOutStatus(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetAlarmOut(iUserID, 0x00ff, 1)) {
            System.out.println("Set alarm out failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            System.out.println("Set alarm out succ!");
        }
        if (!HCNetSDK.getInstance().NET_DVR_GetAlarmOut_V30(iUserID, AlarmOut)) {
            System.out.println("Get alarm out failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
...
//		}
    ...
    public static void Test_VideoEffect(int iPreviewID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_ClientGetVideoEffect(iPreviewID, VideoEffect)) {
            System.out.println("NET_DVR_ClientGetVideoEffect failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_ClientSetVideoEffect(iPreviewID, VideoEffect)) {
            System.out.println("NET_DVR_ClientSetVideoEffect failed:" + +MessageCodeHub.INSTANCE.getErrorCode());
        } else {
...
//		{
//			System.out.println("NET_DVR_INQUEST_PAUSE_CDW" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//		else
//		{
...
//		{
//			System.out.println("NET_DVR_INQUEST_RESUME_CDW" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//		else
//		{
...
//		{
//			System.out.println("NET_DVR_GET_AREA_MASK_CFG" + iChan + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//		else
//		{
...
//		{
//			System.out.println("NET_DVR_SET_AREA_MASK_CFG" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//		else
//		{
...
//		{
//			System.out.println("NET_DVR_GET_AUDIO_DIACRITICAL_CFG" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//		else
//		{
...
//		{
//			System.out.println("NET_DVR_SET_AUDIO_DIACRITICAL_CFG" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//		else
//		{
...
//		{
//			System.out.println("get Preview Display failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}else
//		{
...
//		{
//			System.out.println("Set Preview Display failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//		else
//		{
...
//		}
    ...
    public static void Text_FISHEYE_ABILITY(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetXMLAbility(iUserID, HCNetSDK.FISHEYE_ABILITY, arrayInBuf, strInput.length(), arrayOutBuf, 64 * 1024, intPtr)) {
            System.out.println("get FISHEYE_ABILITY faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_CAMERAPARAMCFG_EX(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_CCDPARAMCFG_EX, iChan, struCameraParamCfgEX)) {
            System.out.println("NET_DVR_GET_CCDPARAMCFG_EX failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_CCDPARAMCFG_EX, iChan, struCameraParamCfgEX)) {
            System.out.println("NET_DVR_SET_CCDPARAMCFG_EX!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_WIRELESSDIAL_CFG(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetSTDConfig(iUserID, HCNetSDK.NET_DVR_GET_WIRELESSSERVER_FULLVERSION_CFG, struCardNo, null, struWirelessDialCfg)) {
            System.out.println("NET_DVR_GET_WIRELESSSERVER_FULLVERSION_CFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetSTDConfig(iUserID, HCNetSDK.NET_DVR_SET_WIRELESSSERVER_FULLVERSION_CFG, struCardNo, struWirelessDialCfg, null)) {
            System.out.println("NET_DVR_SET_WIRELESSSERVER_FULLVERSION_CFG faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_PostRadar_Capabilities(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetSTDAbility(iUserID, HCNetSDK.NET_DVR_GET_POSTRADAR_CAPABILITIES, null, 0, byAbility, 1024 * 1024, iRetLen)) {
            System.out.println("NET_DVR_GET_POSTRADAR_CAPABILITIES" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_Its_Overlap_Cfg_V50(int iUserID, int iChan) {
		...
		{
			System.out.println("NET_ITS_GET_OVERLAP_CFG_V50 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_ITS_SET_OVERLAP_CFG_V50 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
    ...
    public static void TextOSD(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_FACESNAPCFG, 1, struPreviewDisplay)) {
            System.out.println("NET_DVR_GET_FACESNAPCFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_FACESNAPCFG, 1, struPreviewDisplay)) {
            System.out.println("NET_DVR_SET_FACESNAPCFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
...
//        int iUserID = HCNetSDK.getInstance().NET_DVR_CreateOpenEzvizUser(struLoginInfo, struDeviceInfo);
        //if (-1 == iUserID)
//    	{
//    		System.out.println("NET_DVR_CreateEzvizUser" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//    	else
//    	{
...
//        if (!HCNetSDK.getInstance().NET_DVR_STDXMLConfig(iUserID, struInput, struOuput))
//		{
//			System.out.println("NET_DVR_STDXMLConfig" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
//		}
//		else
//		{
...
//		}
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_ALARMIN_PARAM, 1, struTest3)) {
            System.out.println("NET_DVR_SET_ALARMIN_PARAM failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetSTDConfig(iUserID, HCNetSDK.NET_DVR_GET_ALARMIN_PARAM_LIST, struCond, null, struList)) {
            System.out.println("NET_DVR_GetSTDConfig" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDeviceStatus(iUserID, HCNetSDK.NET_DVR_GET_CALL_STATUS, null, struCallStatus)) {
            System.out.println("NET_DVR_GET_CALL_STATUS failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_EzvizServerDeviceInfo(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_SERVER_DEVICE_INFO, 0, struServerDeviceInfo)) {
            System.out.println("NET_DVR_GET_SERVER_DEVICE_INFO failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_CALLER_INFO, 1, struCallerInfo)) {
            System.out.println("NET_DVR_GET_CALLER_INFO failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_EzvizAlarmInParamList(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetSTDConfig(iUserID, HCNetSDK.NET_DVR_GET_ALARMIN_PARAM_LIST, struCond, null, struAlarmInParam)) {
            System.out.println("NET_DVR_GET_ALARMIN_PARAM_LIST faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_EzvizRemoteGatway(int iUserID) {
        ...
        System.arraycopy(byTemp, 0, struTest2.byPassword, 0, byTemp.length);
        if (!HCNetSDK.getInstance().NET_DVR_RemoteControl(iUserID, HCNetSDK.NET_DVR_REMOTECONTROL_GATEWAY, struTest2)) {
            System.out.println("NET_DVR_REMOTECONTROL_GATEWAY failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_EzvizCallSignal(int iUserID) {
        ...
        struTest1.wUnitNumber = 2;
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_CALL_SIGNAL, 1, struTest1)) {
            System.out.println("NET_DVR_SET_CALL_SIGNAL failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_EzvizPawdAuth(int iUserID) {
        ...
        struOuput.dwStatusSize = struOuput.dwOutBufferSize;
        if (!HCNetSDK.getInstance().NET_DVR_STDXMLConfig(iUserID, struInput, struOuput)) {
            System.out.println("NET_DVR_STDXMLConfig PUT /ISAPI/VideoIntercom/passwordAuthentication" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void TestAlarmHostMainStatus(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_ALARMHOST_MAIN_STATUS_V40, 0, struStatus)) {
            System.out.println("NET_DVR_GET_ALARMHOST_MAIN_STATUS_V40 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
...
//		}
    ...
    public static void TextTrialMachine(int iUserID, int iChan) {
		...
		{
			System.out.println("NET_DVR_GET_AUDIO_ACTIVATION_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_SET_AUDIO_ACTIVATION_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
		...
		{
			System.out.println("NET_DVR_GET_AUDIO_DIACRITICAL_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_SET_AUDIO_DIACRITICAL_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
		...
		{
			System.out.println("NET_DVR_GET_AREA_MASK_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_SET_AREA_MASK_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
		...
		{
			System.out.println("NET_DVR_GET_AUDIOIN_VOLUME_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_SET_AUDIOIN_VOLUME_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
		...
		{
			System.out.println("NET_DVR_GET_AUDIOOUT_VOLUME_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_SET_AUDIOOUT_VOLUME_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
		...
		*/
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.NET_DVR_GET_INFRARED_CMD_NAME_CFG, 1, struInfraredCmdName)) {
            System.out.println("NET_DVR_GET_INFRARED_CMD_NAME_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.NET_DVR_SET_INFRARED_CMD_NAME_CFG, 1, struInfraredCmdName)) {
            System.out.println("NET_DVR_SET_INFRARED_CMD_NAME_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
		...
		{
			System.out.println("NET_DVR_GET_USERCFG_V30 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_SET_USERCFG_V30 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
			System.out.println("NET_DVR_SET_USERCFG_V30 succ");
		...
		{
			System.out.println("NET_DVR_GET_TRIAL_SYSTEM_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_InquestStartCDW_V30 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_InquestStopCDW_V30 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_InquestGetPIPStatus_V40 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_InquestSetPIPStatus_V40 failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_INFRARED_OUTPUT_CONTROL" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
		...
		{
			System.out.println("NET_DVR_GET_PREVIEW_SWITCH_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}else
		{
		...
		{
			System.out.println("NET_DVR_SET_PREVIEW_SWITCH_CFG failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
		}
		else
		{
...
//	       struWirelessDial.byUserName = "鐤�";
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetSTDConfig(iUserID, HCNetSDK.NET_DVR_SET_WIRELESS_DIAL, condInt, struWirelessDial, null)) {
            System.out.println("NET_DVR_GET_WIRELESS_DIAL failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Text_Trail_ABILITY(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetXMLAbility(iUserID, HCNetSDK.DEVICE_ABILITY_INFO, arrayInBuf, strInput.length(), arrayOutBuf, 64 * 1024, intPtr)) {
            System.out.println("get Trail_ABILITY faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public static void Test_LEDArea(int iUserID) {
        ...
        if (!HCNetSDKJNAInstance.getInstance().NET_DVR_GetSTDConfig(iUserID, HCNetSDKByJNA.NET_DVR_GET_LED_AREA_INFO_LIST, struSTDConfig.getPointer())) {
            System.out.println("NET_DVR_GET_LED_AREA_INFO_LIST failed!" + "err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
    ...
    public CGReturn PicUpload(int iUserID) {
        ...
        if (f.exists()) {
            Log.i("Casic", "exist " + sFileName);

        } else {
            Log.i("Casic", "not exist " + sFileName);
        }

        m_iHandle = HCNetSDK.getInstance().NET_DVR_PicUpload(iUserID, sFileName, struPic);
        if (m_iHandle == -1) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_PicUpload fail,error coed = " + MessageCodeHub.INSTANCE.getErrorCode());
            return ret;
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_PicUpload success");
        }

        for (int i = 0; i < 100; i++) {
            int iprogress = HCNetSDK.getInstance().NET_DVR_GetPicUploadProgress(m_iHandle);
            Log.i("Casic", "i=" + i + ",---iprogress=" + iprogress);
            //Thread.sleep(10);
        }

        if (HCNetSDK.getInstance().NET_DVR_CloseUploadHandle(m_iHandle)) {
            Log.i("Casic", "NET_DVR_CloseUploadHandle success");
        } else {
            Log.e("Casic", "NET_DVR_CloseUploadHandle fail,error coed = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn BaseMap(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_BASEMAP_WIN_CFG, lChannel, struBaseMap)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_BASEMAP_WIN_CFG success");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_BASEMAP_WIN_CFG fail,error coed = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_SET_BASEMAP_WIN_CFG, lChannel, struBaseMap)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SET_BASEMAP_WIN_CFG success");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SET_BASEMAP_WIN_CFG fail,error coed = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn BasemapCfg(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_BASEMAP_PIC_INFO, lChannel, struPicInfo)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_BASEMAP_PIC_INFO success");
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_BASEMAP_PIC_INFO fail,error coed = " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_GET_BASEMAP_CFG, lChannel, strCtrlCfg)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_GET_BASEMAP_CFG success");
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_GET_BASEMAP_CFG fail,error coed = " + MessageCodeHub.INSTANCE.getErrorCode());

        }

        if (HCNetSDK.getInstance().NET_DVR_SetDVRConfig(iUserID, HCNetSDK.getInstance().NET_DVR_SET_BASEMAP_CFG, lChannel, strCtrlCfg)) {
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.i("Casic", "NET_DVR_SET_BASEMAP_CFG success");
        } else {
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            Log.e("Casic", "NET_DVR_SET_BASEMAP_CFG fail,error coed = " + MessageCodeHub.INSTANCE.getErrorCode());
    ...
    public CGReturn Test_PTZControl(int iPreviewID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZControl(iPreviewID, PTZCommand.PAN_LEFT, 0)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("PTZControl  PAN_LEFT 0 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZControl(iPreviewID, PTZCommand.PAN_LEFT, 1)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("PTZControl  PAN_LEFT 1 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZControlWithSpeed(int iPreviewID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.PAN_RIGHT, 0, 4)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("PTZControlWithSpeed  PAN_RIGHT 0 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.PAN_RIGHT, 1, 4)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("PTZControlWithSpeed  PAN_RIGHT 1 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    /*******/
    public CGReturn PTZControl_Left(int iPreviewID) {
        CGReturn ret = new CGReturn();
        HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.PAN_LEFT, 0, 5);
        ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        try {
            Thread.sleep(2000);
        } catch (InterruptedException e) {
        ...
        HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.PAN_LEFT, 1, 5);
        ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
        return ret;
    }

    public CGReturn PTZControl_Up(int iPreviewID) {
        CGReturn ret = new CGReturn();
        HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.TILT_UP, 0, 5);
        ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        try {
            Thread.sleep(2000);
        } catch (InterruptedException e) {
        ...
        HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.TILT_UP, 1, 5);
        ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
        return ret;
    }

    public CGReturn PTZControl_Right(int iPreviewID) {
        CGReturn ret = new CGReturn();
        HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.PAN_RIGHT, 0, 5);
        ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        try {
            Thread.sleep(2000);
        } catch (InterruptedException e) {
        ...
        HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.PAN_RIGHT, 1, 5);
        ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
        return ret;
    }

    public CGReturn PTZControl_Down(int iPreviewID) {
        CGReturn ret = new CGReturn();
        HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.TILT_DOWN, 0, 5);
        ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        try {
            Thread.sleep(2000);
        } catch (InterruptedException e) {
        ...
        HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed(iPreviewID, PTZCommand.TILT_DOWN, 1, 5);
        ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
        return ret;
    }
    ...
    public CGReturn Test_PTZPreset(int iPreviewID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZPreset(iPreviewID, PTZPresetCmd.GOTO_PRESET, 1)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("PTZPreset  GOTO_PRESET faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZCruise(int iPreviewID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZCruise(iPreviewID, PTZCruiseCmd.RUN_SEQ, (byte) 1, (byte) 1, (short) 1)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("PTZCruise  RUN_SEQ faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZCruise(iPreviewID, PTZCruiseCmd.STOP_SEQ, (byte) 1, (byte) 1, (short) 1)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("PTZCruise  STOP_SEQ faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZTrack(int iPreviewID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZTrack(iPreviewID, PTZTrackCmd.RUN_CRUISE)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZTrack  RUN_CRUISE faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZSelZoomIn(int iPreviewID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZSelZoomIn(iPreviewID, strPointFrame)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZSelZoomIn!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZControl_Other(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZControl_Other(iUserID, iChan, PTZCommand.TILT_UP, 0)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZControl_Other  TILT_UP 0 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZControl_Other(iUserID, iChan, PTZCommand.TILT_UP, 1)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZControl_Other  TILT_UP 1 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZControlWithSpeed_Other(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed_Other(iUserID, iChan, PTZCommand.PAN_RIGHT, 0, 4)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZControlWithSpeed_Other  PAN_RIGHT 0 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZControlWithSpeed_Other(iUserID, iChan, PTZCommand.PAN_RIGHT, 1, 4)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZControlWithSpeed_Other  PAN_RIGHT 1 faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZPreset_Other(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZPreset_Other(iUserID, iChan, PTZPresetCmd.GOTO_PRESET, 1)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZPreset_Other  GOTO_PRESET faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZCruise_Other(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZCruise_Other(iUserID, iChan, PTZCruiseCmd.RUN_SEQ, (byte) 1, (byte) 1, (short) 1)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZCruise_Other  RUN_SEQ faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZCruise_Other(iUserID, iChan, PTZCruiseCmd.STOP_SEQ, (byte) 1, (byte) 1, (short) 1)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZCruise_Other  STOP_SEQ faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZTrack_Other(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZTrack_Other(iUserID, iChan, PTZTrackCmd.RUN_CRUISE)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZTrack_Other  RUN_CRUISE faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PTZSelZoomIn_EX(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_PTZSelZoomIn_EX(iUserID, iChan, strPointFrame)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PTZSelZoomIn_EX failed" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_FindFile_jni(int iUserID) {
        ...
        if (iFindHandle == -1) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_FindFile_V30 failed,Error:" + MessageCodeHub.INSTANCE.getErrorCode());
            return ret;
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        }
    ...
    public CGReturn Test_FindFileByEvent_jni(int iUserID) {
        ...
        if (iFindHandle >= 0) {
            ...
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_FindFileByEvent failed: " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn Test_GetFileDownload_jni(int iUserID) {
        ...
        if (!IsDownlaod) {
            ...
            if (lDownloadHandle < 0) {
                ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
                System.out.println("NET_DVR_GetFileByName failed: " + MessageCodeHub.INSTANCE.getErrorCode());
                return ret;
            } else {
                ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_PlayBackConvert_jni(int iUserID) {
        ...
        if (-1 == nHandle) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_PlayBackByTime failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
            return ret;
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        }
...
//        HCNetSDK.getInstance().NET_DVR_PlayBackControl_V50(nHandle, PlaybackControlCommand.NET_DVR_PLAY_CONVERT, compression, null);
    ...
    public CGReturn Test_GetFileByTime_jni(int iUserID) {
        ...
        if (-1 == nDownloadHandle) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_GetFileByTime failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
            return ret;
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        }
    ...
    public CGReturn Test_GetFileByName_jni(int iUserID) {
        ...
        if (-1 == nDownloadHandle) {
            System.out.println("NET_DVR_GetFileByName failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
            return ret;
        }
        HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(nDownloadHandle, PlaybackControlCommand.NET_DVR_PLAYSTART, null, 0, null);
        int nProgress = -1;
    ...
    public CGReturn Test_UpdateRecordIndex_jni(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_UpdateRecordIndex(iUserID, iChan)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_UpdateRecordIndex failed with:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_CaptureJpegPicture_jni(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_CaptureJPEGPicture(iUserID, iChan, strJpeg, new String("/sdcard/cap.jpg"))) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_CaptureJPEGPicture!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_CaptureJpegPicture_new_jni(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_CaptureJPEGPicture_NEW(iUserID, iChan, strJpeg, sbuffer, iBufferSize, bytesRerned)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_CaptureJPEGPicture_NEW!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_DVRRecord_jni(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_StartDVRRecord(iUserID, 1, 0)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_StartDVRRecord err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_StopDVRRecord(iUserID, 1)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_StopDVRRecord err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_TransChannel_jni(int iUserID) {
        ...
        if (lSerialHandle < 0) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SerialStart failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SerialSend(lSerialHandle, 0, bytes, length)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SerialSend failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SerialStart succ");
        }
        if (!HCNetSDK.getInstance().NET_DVR_SerialStop(lSerialHandle)) {
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SerialStop failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SerialStart succ");
        }
    ...
    public CGReturn Test_Serial_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SendToSerialPort(iUserID, 1, 1, "12345".getBytes(), 5)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SendToSerialPort failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SendTo232Port(iUserID, "12345".getBytes(), 5)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SendTo232Port failed! error:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_ZeroChanPreview_jni(int iUserID) {
        ...
        if (iZeroPreviewHandle < 0) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_ZeroStartPlay failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_ZeroStopPlay(iZeroPreviewHandle)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_ZeroStopPlay failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_Hikonline_jni() {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYSVR_BY_COUNTRYID, struCountryIDCond, struCountryIDRet)) {
            ...
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("QUERYSVR_BY_COUNTRYID failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYDEV_BY_NICKNAME_DDNS, struDDNSCond, struDDNSQueryRet)) {
            ...
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("QUERYDEV_BY_NICKNAME_DDNS failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYDEV_BY_SERIAL_DDNS, struDDNSCond, struDDNSQueryRet)) {
            ...
            ret.status_3 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("QUERYDEV_BY_SERIAL_DDNS failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.CHECKDEV_BY_NICKNAME_DDNS, struDDNSCond, struDDNSCheckRet)) {
            ...
            System.out.println("CHECKDEV_BY_NICKNAME_DDNS failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.CHECKDEV_BY_SERIAL_DDNS, struDDNSCond, struDDNSCheckRet)) {
            ...
            System.out.println("CHECKDEV_BY_SERIAL_DDNS failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn Test_IPServer_jni() {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYDEV_BY_NICKNAME_IPSERVER, struIPServerCond, struIPServerRet)) {
            ...
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("QUERYDEV_BY_NICKNAME_IPSERVER failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetAddrInfoByServer(ADDR_QUERY_TYPE.QUERYDEV_BY_SERIAL_IPSERVER, struIPServerCond, struIPServerRet)) {
            ...
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("QUERYDEV_BY_SERIAL_IPSERVER failed:" + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
    ...
    public CGReturn Test_DVRSetConnectTime_jni() {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetConnectTime(3000)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SetConnectTime err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_DVRSetReConnect_jni() {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetReconnect(3000, true)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SetReconnect err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_SDKLOCAL_CFG_jni(int iUserID) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_GetSDKLocalConfig(SdkLocalCfg)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_GetSDKLocalConfig faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetSDKLocalConfig(SdkLocalCfg)) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SetSDKLocalConfig faild!" + " err: " + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_GetSDKVersion_jni() {
        ...
        if (SDKVersion < 0) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_GetSDKVersion err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
        ...
        if (SDKBuildVersion < 0) {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_GetSDKVersion_GetSDKBuildVersion err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_2 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_DVRMakeKeyFrame_jni(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_MakeKeyFrame(iUserID, iChan)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_MakeKeyFrame err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_DVRMakeKeyFrameSub_jni(int iUserID, int iChan) {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_MakeKeyFrameSub(iUserID, iChan)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_MakeKeyFrameSub err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    public CGReturn Test_SetRecvTimeOut_jni() {
        ...
        if (!HCNetSDK.getInstance().NET_DVR_SetRecvTimeOut(5000)) {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_SetRecvTimeOut err:" + MessageCodeHub.INSTANCE.getErrorCode());
        } else {
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
    ...
    */
    ...
    public CGReturn Test_GetCurrentAudioCompress_V50(int iUserID) {
        ...
        if (HCNetSDK.getInstance().NET_DVR_GetCurrentAudioCompress_V50(iUserID, audioChannel, audioCompression)) {
            ...
            ret.status_1 = MessageCodeHub.INSTANCE.getErrorCode();
            System.out.println("NET_DVR_GetCurrentAudioCompress_V50 failed: " + MessageCodeHub.INSTANCE.getErrorCode());
        }
        return ret;
    }
